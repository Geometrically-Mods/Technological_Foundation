...
public class GuiCheckGameCode extends GuiContainer {
	...
	public GuiCheckGameCode(InventoryPlayer inventoryPlayer, TileEntity tileEntity, Block block){
    ...
    public void initGui(){
		...
		this.keycodeTextbox = new GuiTextField(this.fontRendererObj, this.width / 2 - 37, this.height / 2 - 67, 77, 12);
	...
	public void checkCode(String par1String) {
		ConsoleCore.network.sendToServer(new PacketSCheckPassword(tileEntity.xCoord, tileEntity.yCoord, tileEntity.zCoord, par1String));		
	}
