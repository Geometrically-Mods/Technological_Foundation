...
import com.geometrically.ConsoleMod.model.ModelTelevision;
...
public class RenderTV extends TileEntitySpecialRenderer {
    private static final ResourceLocation texture = new ResourceLocation("tf:textures/model/Television.png");
    private ModelTelevision model = new ModelTelevision();
